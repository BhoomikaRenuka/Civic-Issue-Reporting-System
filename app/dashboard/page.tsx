...
import { Plus, FileText, Users, CheckCircle, AlertTriangle, Clock } from "lucide-react"
...
export default function DashboardPage() {
  ...
  const fetchDashboardData = async () => {
    try {
      const [myReportsRes, allIssuesRes] = await Promise.all([issuesApi.getMyReports(), issuesApi.getAllIssues()])
